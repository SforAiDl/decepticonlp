...
class RankWords:
    ...
    def temporal_score(self, sentence):
        """ 
            ...
            >> print(rw.temporal_score(embedded_word))  #seed = 99
    ...
    def temportal_tail_score(self, sentence):
        """ 
            ...
            >> rw = temporal_metrics.RankWords()
            >> embedded_word = embed("i like dogs") #embed should convert the sentence to a (sent_length * embedding_dim) shape tensor
            >> print(rw.temportal_tail_score(embedded_word)) #seed = 99
    ...
    def combined_score(self, sentence, lambda_):
        """ 
            ...
            >> rw = temporal_metrics.RankWords()
            >> embedded_word = embed("i like dogs") #embed should convert the sentence to a (sent_length * embedding_dim) shape tensor
            >> print(rw.combined_score(embedded_word,0.5)) #seed = 99
